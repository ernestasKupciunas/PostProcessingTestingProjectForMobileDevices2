...
v9.6.2 Current Release
- Added support for Single Pass Instanced
- [Fix] Fixed Sun shafts in Single Pass Stereo/Single Pass Instanced (Unity 2018.3+)

v9.6.1 2019-MAR-01
- New "Sync With Profile" option. Specified if profile changes should override script settings or if profile should be loaded on start.
- [Fix] Fog areas do not refresh in Editor automatically when compute depth setting is changed
