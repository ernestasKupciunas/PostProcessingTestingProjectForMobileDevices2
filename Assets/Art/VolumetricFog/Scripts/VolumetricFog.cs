...
namespace VolumetricFogAndMist {
    ...
    public partial class VolumetricFog : MonoBehaviour {
        ...
        const string VFM_BUILD_HINT = "VFMBuildHint962b2";
        ...
        internal void DoOnRenderImageInstance(Camera mainCamera, RenderTexture source, RenderTexture destination) {
            ...
            if (_hasCamera) {
                ...
                if (_spsrBehaviour == SPSR_BEHAVIOUR.AutoDetectInEditor) {
                    useSinglePassStereoRenderingMatrix = PlayerSettings.stereoRenderingPath != StereoRenderingPath.MultiPass;
                }
#endif
        ...
        void UpdateScatteringData() {
            ...
            Vector3 viewportPos = mainCamera.WorldToViewportPoint(sunSkyPos, UnityEngine.XR.XRSettings.enabled ? Camera.MonoOrStereoscopicEye.Left : Camera.MonoOrStereoscopicEye.Mono);
            ...
            if (viewportPos.z < 0) {
                ...
                {
                    Vector3 sunScrPosRightEye = mainCamera.WorldToViewportPoint(sunSkyPos, Camera.MonoOrStereoscopicEye.Right);
